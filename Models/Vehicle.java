...
public class Vehicle extends Mappable<Vehicle> {
    ...
    public Vehicle() {} // Required for Mappable
    ...
    public String getClaimTicket() { return claimTicket; }
    public void setClaimTicket(String claimTicket) { this.claimTicket = claimTicket; }
    public String getParkedBy() { return parkedBy; }
    public void setParkedBy(String parkedBy) { this.parkedBy = parkedBy; }
}
