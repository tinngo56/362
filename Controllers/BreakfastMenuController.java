//package Controllers;
//
//import Models.CookFood.IngredientDetail;
...
//
//
//public class BreakfastMenuController {
//
...
//
//    public BreakfastMenuController(String baseDirectory) throws IOException {
...
//    }
//
//    public void prepare(int numberOfGuests) {
//        System.out.println("Preparing " + getName() + " for " + numberOfGuests + " guests.");
//        Map<String, IngredientDetail> ingredients = recipe.getIngredientsForGuests(numberOfGuests);
...
//            System.out.println(entry.getKey() + ": " + detail.getQuantityPerGuest() + " " + detail.getUnit());
//        }
